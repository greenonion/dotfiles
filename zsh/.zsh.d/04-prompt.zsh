...
# zstyle ':vcs_info:git*' formats "%F{magenta}(%s)%f %8.8i ${green}%c${red}%u%F{cyan} %b%m"
# zstyle ':vcs_info:git*' actionformats "(%F{magenta}(%s)%f|${yellow}%a${cyan}) %8.8i ${green}%c${red}%u${cyan} %b%m"
# #zstyle ':vcs_info:git*+set-message:*' hooks git-st git-stash

# # Show remote ref name and vcs-string number of commits ahead-of or behind
# function +vi-git-st() {
